...
look tidier. However, the NMIs are pretty close, as the tidyness of
...
much more stable on the given datasets, save for the \texttt{higher\_dimensional} dataset
which is difficult to cluster.
