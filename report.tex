...
\Function{orclus}{\textit{Database: $DB$, \# of Clusters: $k$, \# of Dimensions: $l$}}
    ...
    \State $S =$ \Call{kmeanspp}{$DB$, $k_c$}; \Comment{choose initial seeds with K-means++}
    \ForAll{$i \in \{1 ... k_c\}$}
...
\begin{figure}[tb]
    ...
    \begin{subfigure}[t]{0.33\textwidth}
        ...
        \caption{Our implementation TODO}
        \label{fig:test-ours}
    \end{subfigure}%
    \begin{subfigure}[t]{0.33\textwidth}
        \centering
        \includegraphics[width=\textwidth]{img/test_ours}
        \caption{ELKI's implementation TODO}
    \end{subfigure}%
    \begin{subfigure}[t]{0.33\textwidth}
        \centering
...
Figure~\ref{fig:test_noisy_true} shows the ground truth for this dataset, while
Figures~\ref{fig:test_noisy_ours}~and~\ref{fig:test_noisy_elki} show the results
of our implementation and ELKI's implementation, respectively.

\begin{figure}[tb]
    \centering
    \begin{subfigure}[t]{0.33\textwidth}
        \centering
        \includegraphics[width=\textwidth]{img/test_noisy_ours}
        \caption{Our implementation TODO}
        \label{fig:test_noisy_ours}
    \end{subfigure}%
    \begin{subfigure}[t]{0.33\textwidth}
        \centering
        \includegraphics[width=\textwidth]{img/test_ours}
        \caption{ELKI's implementation TODO}
        \label{fig:test_noisy_elki}
    \end{subfigure}%
    \begin{subfigure}[t]{0.33\textwidth}
        \centering
        \includegraphics[width=\textwidth]{img/test_noisy}
        \caption{Ground truth}
        \label{fig:test_noisy_true}
    \end{subfigure}%

    \caption{Results obtained by running the algorithm vs. the ground truth}
    \label{fig:test}
\end{figure}
